...
<body>
<div class="container">
    <h3 style="font-weight: bold; text-align: center;">Owner Register</h3>
    <hr><br>
    <form method="POST" action="owner-engine.php" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="password2" placeholder="Enter Password Again" name="password2" oninput="checkPasswordsMatch()" required>
        ...
        <hr>
        <button id="submit" name="owner_register" class="btn btn-primary btn-block" onclick="return Validate()">Register</button><br>
