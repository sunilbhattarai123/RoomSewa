...
<body>
    ...
    global $sender_id,$receiver_id,$sender_name,$receiver_name;
        ...
        $sql= "SELECT full_name from tenant where tenant_id='$sender_id';";
        ...
        $sql1= "SELECT full_name from owner where owner_id='$receiver_id';";
            ...
            function getChatHistory() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response) { // Check for 'succ' key instead of 'success'
                            let chatHistory = response.chatHistory;
                            // console.log('bye');
                            // console.log(chatHistory)
                            //let data = JSON.parse(chatHistory);
